class ApplicationController < Sinatra::Base
  ...
  patch '/update/:todo_id' do
    ...
    msg = {:success => "Edit on todo with id: #{params[:todo_id]} successful."}
    @res = msg.to_json 
  end
  ...
  post '/create' do
    ...
    # msg = {:success => "New Todo with id: #{params[:todo_id]} created successfully."}
    # @res = msg.to_json 
  end
  ...
  post "/signin" do
    ...
    if User.exists?(username: params[:username])
      ...
      if db_password == params[:password]
        ...
        msg = {:success => "Signed in #{params[:username] } successfully", :user_id => check_user[:id], :username => check_user[:username]} 
        @res = msg.to_json
      else
